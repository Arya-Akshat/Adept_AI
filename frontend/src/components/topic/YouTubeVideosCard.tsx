...
const VideoCard = ({ video }: VideoCardProps) => (
  <a
    ...
    className="group flex flex-col w-[260px] sm:w-[280px] shrink-0 rounded-2xl overflow-hidden bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md hover:border-red-100 dark:hover:border-red-900/30 transition-all duration-300"
  >
